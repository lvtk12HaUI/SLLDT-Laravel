...
<body>
    <table>
        ...
        <tr>
            <td colspan="7" style="color:#000000;font-size:20px;text-align: center;font-weight:bold">DANH SÁCH HỌC SINH LỚP - {{$class->class_name}}</td>
        </tr>
        <tr>
            <td colspan="7" style="background-color:#ffffff;"></td>
        </tr>
        ...
        <tr>
            <td colspan="7" style="background-color:#ffffff;border-bottom:1px solid gray;"></td>
        </tr>
        <tr>
            <td style="color:#000000;width:5px;font-size:12px;text-align: center;font-weight:bold">STT</td>
            <td style="color:#000000;width:15px;font-size:12px;text-align: center;font-weight:bold">MÃ HỌC SINH</td>
        ...
        <tr>
            ...
            <td style="border:1px solid #000000;text-align: left">{{$val->student_number}}</td>
            <td style="border:1px solid #000000;text-align: left">{{$val->student_name}}</td>
